...
const Cards = (props) => {
  return (
   ...
   <div className="p-1"> <h1 className={`${styles.title} text-[#ffffff]`}>{props.name}</h1>
   <section className="flex gap-3 mt-2"><p className={` bg-[#0000002f] rounded-lg backdrop-blur-2xl px-3 py-0.5 ${styles[props.element]}`}  >{props.element} </p>  <p>{props.region}</p ></section>
        </div>
